...
class CommandNamespace
{
     ...
     * @return CommandController
     */
    public function getSignature($command_name)
    {
        return isset($this->signatures[$command_name]) ? $this->signatures[$command_name] : null;
    }
    ...
    protected function loadCommandMap($controller_file)
    {
        ...
        $signature = property_exists($controller, "signature") && $controller->signature instanceof CommandSignature ? $controller->signature : null;
        $this->signatures[$command_name] = $signature;
